 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, IArchivo {
    ...
    private void attemptLogin() {
        ...
        parametros.add(new String(hostname));
        parametros.add(new String(email));
        parametros.add(new String(password));
    ...
    public void doAfterFTRConect() {
        //Guardo archivo preferencias
        if (check.isChecked()){
            SharedPreferences sharedPref = this.getPreferences(Context.MODE_PRIVATE);
            SharedPreferences.Editor editor = sharedPref.edit();
            editor.putString("hostname", parametros.get(0));
            editor.putString("user", parametros.get(1));
            editor.putString("pw", parametros.get(2));
            editor.commit();
            System.out.println("Preferencias guardadas");
        }

        Intent intent = new Intent(LoginActivity.this, Menu_lateral.class);
        intent.putExtra("hostname", parametros.get(0));
        intent.putExtra("user", parametros.get(1));
        intent.putExtra("pw", parametros.get(2));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                if(checkInternet(LoginActivity.this)) {
                    new FTPConnection(parametros, LoginActivity.this).execute();
                }else{
                    System.out.println("No tiene inet");
                }
